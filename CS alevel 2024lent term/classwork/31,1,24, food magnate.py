...
class Simulation:
  ...
  def AddCompany(self):
    ...
    while CompanyName == "" or self.GetIndexOfCompany(CompanyName) != -1:
      print("Your company name is invalid. Please use another company name.")
      CompanyName = input("Enter a new name for the company: ")
